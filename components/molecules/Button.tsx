...
export const ButtonWrapper: React.FC<ButtonWrapperProps> = ({
  ...
  return (
    <button
      className={`${buttonWidth} px-3 py-[0.75rem] font-semibold bg-primary hover:bg-primary hover:shadow text-white rounded-md my-0 flex justify-center items-center relative box-border ${
